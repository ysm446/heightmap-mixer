...
#define MM_EXPORT_BASE_COLOR 0
#define MM_EXPORT_NORMAL     1
#define MM_EXPORT_ROUGHNESS  2
#define MM_EXPORT_METALLIC   3
#define MM_EXPORT_AO         4
#define MM_EXPORT_HEIGHT     5
#define MM_EXPORT_ORD        6  // AO / Roughness / Height
#define MM_EXPORT_ORM        7  // AO / Roughness / Metallic
...
void CsMain(uint3 dispatchThreadId : SV_DispatchThreadID)
{
    ...
    switch (g_export.map)
    {
        ...
        default:
        {
            ...
            switch (g_export.map)
            {
                case MM_EXPORT_ROUGHNESS: result.rgb = packed.rrr; break;
                case MM_EXPORT_METALLIC:  result.rgb = packed.ggg; break;
                case MM_EXPORT_AO:        result.rgb = packed.bbb; break;
                case MM_EXPORT_ORD:
                {
                    Texture2D<float> height = ResourceDescriptorHeap[g_export.heightIndex];
